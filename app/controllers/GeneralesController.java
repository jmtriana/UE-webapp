...
public class GeneralesController extends Controller {
    ...
    public Result graficosIndicadores() {
        ...
        Item[] ids = listToArrayI(Item.finderItems.all());
        /*long[] b = new long[a.length];

        for(int i=0;i<a.length;i++){
        //Item.finderItems.deleteById(a[i]);
        }*/

        Form<Historico> formHistorico = Form.form(Historico.class);
        return ok(views.html.graficos.render(formHistorico,vector_indice, arr, indic.score, indic.scoreReal,aHistorico,ids));
    }
...
//=============================================== CAPTURA VARIABLES ========================================
            ...
            String sel_mw4 = formGeneral.field("mw4").value();
            String sel_mw5 = formGeneral.field("mw5").value();
            String sel_mw6 = formGeneral.field("mw6").value();
            String sel_mw7 = formGeneral.field("mw7").value();
            String [] act_mw = new String[4];
            String [] act_mwb = new String[4];
            act_mw[0]=sel_mw;
            act_mw[1]=sel_mw1;
            act_mw[2]=sel_mw2;
            act_mw[3]=sel_mw3;
...
switch (op){
    ...
    case 2: //=======================================Caso microondas
        if(act_mw[0].equals("mw") && act_mwb[0].equals("mw4")){//====
            actividad_seleccionada="A 0.3/0.6 - B 0.3/0.6";
        }else if(act_mw[0].equals("mw") && act_mwb[0].equals("mw5")){
            actividad_seleccionada="A 0.3/0.6 - B 0.9/1.2";
        }else if(act_mw[0].equals("mw") && act_mwb[0].equals("mw6")){
            actividad_seleccionada="A 0.3/0.6 - B 1.8/2.4";
        }else if(act_mw[0].equals("mw") && act_mwb[0].equals("mw7")){ //====
            actividad_seleccionada="A 0.3/0.6 - B 3.0/3.7";
        }else if(act_mw[0].equals("mw1") && act_mwb[0].equals("mw4")){
            actividad_seleccionada="A 0.9/1.2 - B 0.3/0.6";
        }else if(act_mw[0].equals("mw1") && act_mwb[0].equals("mw5")){
            actividad_seleccionada="A 0.9/1.2 - B 0.9/1.2";
        }else if(act_mw[0].equals("mw1") && act_mwb[0].equals("mw6")){
            actividad_seleccionada="A 0.9/1.2 - B 1.8/2.4";
        }else if(act_mw[0].equals("mw1") && act_mwb[0].equals("mw7")){ //====
            actividad_seleccionada="A 0.9/1.2 - B 3.0/3.7";
        }else if(act_mw[0].equals("mw2") && act_mwb[0].equals("mw4")){
            actividad_seleccionada="A 1.8/2.4 - B 0.3/0.6";
        }else if(act_mw[0].equals("mw2") && act_mwb[0].equals("mw5")){
            actividad_seleccionada="A 1.8/2.4 - B 0.9/1.2";
        }else if(act_mw[0].equals("mw2") && act_mwb[0].equals("mw6")){
            actividad_seleccionada="A 1.8/2.4 - B 1.8/2.4";
        }else if(act_mw[0].equals("mw2") && act_mwb[0].equals("mw7")){ //===
            actividad_seleccionada="A 1.8/2.4 - B 3.0/3.7";
        }else if(act_mw[0].equals("mw3") && act_mwb[0].equals("mw4")){
            actividad_seleccionada="A 3.0/3.7 - B 0.3/0.6";
        }else if(act_mw[0].equals("mw3") && act_mwb[0].equals("mw5")){
            actividad_seleccionada="A 3.0/3.7 - B 0.9/1.2";
        }else if(act_mw[0].equals("mw3") && act_mwb[0].equals("mw6")){
            actividad_seleccionada="A 3.0/3.7 - B 1.8/2.4";
        }else if(act_mw[0].equals("mw3") && act_mwb[0].equals("mw7")){
            actividad_seleccionada="A 3.0/3.7 - B 3.0/3.7";
        }else{
...
// FIN INDICADORES
    ...
    public Item[] listToArrayI(List<Item> arrayI) {

        Item[] result = new Item[arrayI.size()];
        for (int i = 0; i < arrayI.size(); i++) {
            result[i] = arrayI.get(i);
        }
   ...
   public Result postHistorico() throws ParseException {
       ...
       if(request().method().equals("POST")){
           ...
           String clr_id = formHistorico.field("ids").value().toString();
           String[] clr_ids = clr_id.split(",");
           ...
           System.out.println("ID Split: "+ Arrays.toString(clr_ids));

           long [] aux_ids = new long[clr_ids.length];
           for(int i=0;i<clr_ids.length;i++){
               aux_ids[i] = Long.parseLong(clr_ids[i]);
           }
           for(int j=0;j<aux_ids.length;j++){
               Item.finderItems.deleteById(aux_ids[j]);
           }
