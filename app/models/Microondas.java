...
public class Microondas extends Model{
    ...
    public Microondas(){
        ...
        Item item2_1mw = new Item("El lugar debe estar limpio y organizado, las partes sobrantes deben quedar organizadas registradas y entregadas al cliente.",0.2,"","Microondas","19.1.005");
        itemsMicro.add(item2_1mw);
        itemsHSEm.add(item2_1mw);
        x = Item.finderItems.where().like("descripcion", item2_1mw.descripcion).findUnique();
        if(x == null){
            item2_1mw.save();
        }
